...
public class CloudAuthorizationService {
    ...
    private static final String LOGIN_USERNAME = "angelbuzov123@gmail.com";

    private static final String LOGIN_PASSWORD = "pcloudpass";

    private static final String LOGIN_URL = "https://api.pcloud.com/userinfo?getauth=1&logout=1&username="
            + LOGIN_USERNAME
            + "&password="
            + LOGIN_PASSWORD;
